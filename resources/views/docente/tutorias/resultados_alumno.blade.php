		...
		<div class="section">
			<div class="row">
				<div class="col-md-6 ml-auto mr-auto">
					<div class="profile">   						
						<div class="name">
							<h3 class="title">Respuestas del Alumno <b class="text-primary">{{$alumno->name}}</b></h3>		
						</div>
					</div>
				</div>
			</div>		
			<div class="text-center">
				<a href="{{url('/docente/tutorias')}}" class="btn btn-danger">Regresar</a>
			...
			<div class="row">				
				...
				<div class="row">				
					...
					<div class="text-center col-md-12">
						<a href="{{url('/docente/tutorias')}}" class="btn btn-danger">Regresar</a> 
						<a href="{{url('docente/entrevista_fresca_padre_familia/'.$entrevista->alumno_id)}}" class="btn btn-success">Descargar Pdf</a>
					</div>
				</div>              
			</div>
		</div>

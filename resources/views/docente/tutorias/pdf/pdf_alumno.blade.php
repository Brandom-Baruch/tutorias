...
<body>
	...
	<div class="container">
		<div class="section">			
			<div class="text-center">   														
				<h2 style="margin: auto 2px;">Respuestas del Alumno: {{$alumno->name}} {{$alumno->apellidoP}} {{$alumno->apellidoM}}</h2>		
			</div>							
	...
	<div class="container">
		<div class="section">												
			<h3 class="title text-primary" style="margin-top: 50px;">Hábitos de Estudio</h3>			
			<div style="padding: 10px; float: left; width: 45%;">

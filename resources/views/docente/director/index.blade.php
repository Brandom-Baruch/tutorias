                  ...
                  <tr>
                      ...
                      <td class="td-actions text-center">
                          <form method="post" action="{{url('/director/docente/'.$docente->id.'/delete')}}">
                            {{csrf_field()}}
                            <a href="" rel="tooltip" title="Ver docente" class="btn btn-info btn-fab btn-fab-mini btn-rect btn-sm">
                  ...
                  <tr>
                      ...
                      <td class="td-actions text-center">
                        <form method="post" action="">
                          <a href="" rel="tooltip" title="Ver Materia" class="btn btn-info btn-fab btn-fab-mini btn-rect btn-sm">
                              <i class="fa fa-user"></i>
                          </a>

                          <a href="" rel="tooltip" title="Editar Materia" class="btn btn-success btn-fab btn-fab-mini btn-rect btn-sm">
                              <i class="fa fa-edit"></i>
                          </a >
